...
//        jobOfferLabel.font = UIFont(name: jobOfferLabel.font.fontName, size: 16)
...
//        detailInformationUI.createDistance(view: self, container: containerDetail, detailView: distanceDetailView)
//        
//        
//        
//        //types detail view
